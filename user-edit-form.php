<?php
    $q = "select usuario, nome, tipo from usuarios where usuario = '" . $_SESSION['user'] . "'";
    $busca = $banco->query($q);
...
<form action="user-edit.php" method="post">
    <table>
        ...
        <tr><td>Tipo
            <td><input type="text" name="tipo" id="tipo" size="10" maxlength="10" readonly value = "<?php echo $reg->tipo; ?>">
        <tr><td>Senha:
